...
public class StudentControllerTest {
    ...
    @Autowired
    private MockMvc mvc;
//this controller has also bean//has a dependency
    //i dont want to inject real bean so use MOckBean
    @MockBean
    ...
    void getStudent_Test() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/student")
                ...
                .andDo(print())//if you want to see in console
                .andReturn();
    ...
    void getStudents_Test() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/students")
                ...
                .andDo(print())
                .andReturn();
//if it is list dont forget squarebrackets[]
    }
